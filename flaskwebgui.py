...
class FlaskUI:
    ...
    def __init__(self, app=None, width=800, height=600, fullscreen=True, maximized=True, app_mode=True,  browser_path="", server="flask", host="127.0.0.1", port=5000, socketio=None, on_exit=None):
        self.flask_app = app
