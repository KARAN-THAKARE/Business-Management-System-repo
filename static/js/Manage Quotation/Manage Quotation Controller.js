...
//_________________________________________________________________________________________________________________
//_______________________________   MANGE_QUOTATION CONTROLLER MODULE  _______________________________________________
//_________________________________________________________________________________________________________________


app.controller('Manage_Quotation_Controller', function($scope,$window,$http,$log) {


SEND_QUOTATION_ON_MAIL=function(ID,ClientName) {

    Notiflix.Loading.Pulse('Sending...');
    URL="/SEND_QUOTATION_ON_MAIL.do/"+ID
    $http.post(URL).
    success(function(results) {
    if(results.isSuccess=='true'){
      var Message ="Hey user,Quotation has been successfully sent on " +  ClientName + "'s Email ID as per your request."
      Notiflix.Loading.Remove();
      Notiflix.Report.Success('Successfully Sent !',Message,'Okey');
    }else{
      var Message ="Hey user, Software is trying to send Quotation on "+ ClientName + "'s Email ID but " + results.FrontEndMesg
      Notiflix.Loading.Remove();
...
//_________________________________________________________________________________________________________________
//__________________________ END  MANGE_QUOTATION CONTROLLER MODULE END  __________________________________________
//_________________________________________________________________________________________________________________
