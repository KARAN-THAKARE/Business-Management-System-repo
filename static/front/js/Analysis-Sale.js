...
app.controller('SELL_ANALYSIS_CONTROLLER', function($scope,$window,$http,$log) {
        ...
        data: {
          labels: ["January", "February", "March", "April", "May", "June", "July","August", "September", "October", "November", "December "],
            datasets: [
              ...
              {
                  label: "Total amount paid for sale ₹",
                  fill: true,
                  lineTension: 0.3,
              ...
              {
                  label: "Total unpaid amount for sale ₹",
                  fill: true,
                  lineTension: 0.2,
